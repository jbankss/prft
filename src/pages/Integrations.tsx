...
import { Copy, Check, ShoppingBag, CreditCard, Package, MessageSquare, Send } from 'lucide-react';
...
export default function Integrations() {
  ...
  const webhookUrl = currentBrand 
    ? `https://ulkxtkopehmiszfdjuys.supabase.co/functions/v1/shopify-orders?brand_id=${currentBrand.id}`
    : '';
              ...
              <div className="lg:col-span-2 space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Automatically create invoices when products sell on Shopify
                    </CardDescription>
                  </CardHeader>
              ...
              <div className="lg:col-span-1">
                <Card className="h-full">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Ask questions about setting up integrations
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
